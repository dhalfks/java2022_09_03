...
//				destPage="pageList";
		...
		case "pageList":
			try {
				...
				pgvo.setType(req.getParameter("type"));
				pgvo.setKeyword(req.getParameter("keyword"));
				log.info(pgvo.getKeyword());
				log.info(pgvo.getType());
				int totCount = bsv.getPageCnt(pgvo); //전체 카운트 호출
